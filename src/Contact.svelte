    ...
    <Transition
      ...
      <section class="w-full">
        ...
        <p class="section-paragraph md:text-left text-gray-500 ">
            I'm always open to new opportunities, so if you have any questions or just want to say hi, feel free to contact me.
        </p>
        <div class="w-full grid lg:grid-cols-2 gap-8 lg:gap-32 mt-24">
          <div class="space-y-12">
            <form action="https://fabform.io/f/RQ0RMXl" method="post">
                <div> 
                    <label class="text-white block mb-6 text-xl font-bold" for="name">Name</label>
                    <input
                        type="text"
                ...
                <div>
                    <label class="text-white block mb-6 text-xl font-bold" for="email">Email</label>
                    <input
                        type="email"
                        class="text-black w-full border border-input-border bg-input px-4 py-4"
                        name="email"
                ...
                <button class="btn btn-primary px-6 py-2 bg-theme text-white font-bold" type="submit">
                Send It!
                </button>
            </form>
          </div>
          ...
          <div class="mt-12">
            <!-- Contact info -->
            <a href="mailto:wylited@gmail.com"
